...
export default function CreateAppointmentModal({
  ...
  // ✅ IMPROVED: Handles the Android lifecycle properly
  const handleDateChange = (event, selectedDate) => {
    ...
    if (event.type === "set" && selectedDate) {
      ...
      // Android specific: If they just picked the date, now show the time
  ...
  return (
    <>
          ...
          <View style={s.card}>
            ...
            >
              ...
              >
                ...
                <Text
                  style={[s.input, { color: clientId ? "#000613" : "#9CA3AF" }]}
                >
              ...
              <TouchableOpacity style={s.inputRow} onPress={showPicker}>
      ...
      {/* Android Picker: Rendered outside the Modal to prevent layout glitches */}
