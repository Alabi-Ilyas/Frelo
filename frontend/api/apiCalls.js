...
export const updateEmail       = (data) => API.patch("/users/email", data).then(r => r.data);
export const updatePreferences = (data) => API.patch("/users/preferences", data).then(r => r.data);
export const deleteAccount     = ()     => API.delete("/users/account").then(r => r.data);

/* ── DASHBOARD ────────────────────────────────────────────────────────── */
export const getDashboardData   = () => API.get("/dashboard/freelancer").then(r => r.data);
...
export const getProjectDetails = (id)    => API.get(`/projects/${id}`).then(r => r.data);
export const createProject    = (data)   => API.post("/projects", data).then(r => r.data);
export const updateProject    = (id, data) => API.patch(`/projects/${id}`, data).then(r => r.data);
export const deleteProject    = (id)     => API.delete(`/projects/${id}`).then(r => r.data);
// Client
export const getClientProjects   = ()   => API.get("/projects/client/me").then(r => r.data);
export const getClientProjectById = (id) => API.get(`/projects/client/${id}`).then(r => r.data);

/* ── TASKS (freelancer only) ──────────────────────────────────────────── */
export const fetchAllTasks    = (params)              => API.get("/tasks", { params }).then(r => r.data);
export const addTask          = (projectId, data)     => API.post(`/tasks/project/${projectId}`, data).then(r => r.data);
export const updateTask       = (projectId, taskId, data) => API.patch(`/tasks/project/${projectId}/${taskId}`, data).then(r => r.data);
export const updateTaskStatus = (projectId, taskId, status) =>
  API.patch(`/tasks/project/${projectId}/${taskId}/status`, { status }).then(r => r.data);
export const deleteTask       = (projectId, taskId)   => API.delete(`/tasks/project/${projectId}/${taskId}`).then(r => r.data);

/* ── CLIENTS (freelancer only) ────────────────────────────────────────── */
export const getClients      = (params) => API.get("/clients", { params }).then(r => r.data);
export const getClientDetails = (id)    => API.get(`/clients/${id}`).then(r => r.data);
...
export const getInvoiceDetails   = (id)     => API.get(`/invoices/${id}`).then(r => r.data);
...
// Client
export const getClientInvoices   = ()       => API.get("/invoices/client/me").then(r => r.data);
...
export const getUpcomingAppointments = ()       => API.get("/appointments/upcoming").then(r => r.data);
...
// Client
export const getClientAppointments = ()                    => API.get("/appointments/client/me").then(r => r.data);
export const bookAppointment       = (data)                => API.post("/appointments/book", data).then(r => r.data);
export const getAvailableSlots     = (freelancerId, date)  =>
  API.get("/appointments/available-slots", { params: { freelancerId, date } }).then(r => r.data);
// Shared cancel
...
export const addBlockedDate     = (data) => API.post("/availability/blocked-dates", data).then(r => r.data);
// Client
export const getClientAvailability    = ()     => API.get("/users/availability").then(r => r.data);
export const updateClientAvailability = (data) => API.put("/users/availability", data).then(r => r.data);

/* ── CLIENT PORTAL ────────────────────────────────────────────────────── */
export const getMyFreelancers = () => API.get("/users/my-freelancers").then(r => r.data);
